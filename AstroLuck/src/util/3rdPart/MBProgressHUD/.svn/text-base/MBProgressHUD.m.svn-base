...
#define __use_default_super_bounds 1
...
#if __use_default_super_bounds
#define MBP_DefaultSuperBound(v) CGRectMake(0,0,320,316)
#else
#define MBP_DefaultSuperBound(v) (v).bounds
#endif
...
- (void)layoutSubviews {
	...
	if (parent) {
        ...
        self.frame = MBP_DefaultSuperBound(parent);
	}
    ...
    //	NSLog(@"indicator's frame:%@  label:%@  detailsLabel:%@", indicator, label, detailsLabel);
	self.size = totalSize;
}
